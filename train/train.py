...
from src.yolo import YOLOV5s, YoloWithLossCell
from src.logger import get_logger
from src.util import AverageMeter, get_param_groups, keep_loss_fp32
...
def train(cloud_args=None):
    ...
    ttt = 1.0
    bbb = FixedLossScaleManager(ttt, drop_overflow_update=False)
    network = amp.build_train_network(network, optimizer=opt, loss_scale_manager=bbb,
